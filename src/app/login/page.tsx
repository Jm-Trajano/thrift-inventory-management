    ...
    <main className="min-h-screen lg:grid lg:grid-cols-2">
      ...
      <section className="flex min-h-screen flex-col justify-center px-8 py-16 sm:px-12 lg:px-24">
        <div className="mb-14 space-y-3">
          ...
          <h2 className="text-4xl text-ink-primary">Welcome back</h2>
          <p className="max-w-md text-sm leading-6 text-ink-secondary">
            Sign in to manage stock, record sales, and keep the shop floor in
            sync with what is actually available.
          </p>
        </div>
